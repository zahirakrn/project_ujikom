    ...
    <div class="content-page">
        <div class="content">
            <h4 class="fw-bold py-3 mb-4">
                <span class="text-muted fw-light">Tabel /</span> Tambah Penggajian
            </h4>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('penggajian.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="example-palaceholder" class="form-control"
                                        placeholder="Jumlah Gaji" name="jumlah_gaji">
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="date" id="example-palaceholder" class="form-control"
                                        placeholder="Tanggal Gaji" name="tanggal_gaji">
                                </div>
                                <div class="mb-3">
                                    <label for="simpleinput" class="form-label">Status</label>
                                    <select id="simpleinput" class="form-select" aria-label="Default select example" name="status">
