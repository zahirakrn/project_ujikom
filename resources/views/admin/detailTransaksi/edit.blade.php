...
@section('content')
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('detailtransaksi.update',$detailTransaski->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="basic-default-name" placeholder="jumlah"
                            name="jumlah" value="{{$detailTransaksi->jumlah}}"/>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="basic-default-name" placeholder="Harga"
                            name="harga" value="{{$detailTransaksi->harga}}" />
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label" for="basic-default-fullname">Subtotak</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="basic-default-name" placeholder="Subtotal"
                            name="subtotal" value="{{$detailTransaksi->subtotal}}" />
                    </div>
                </div>
