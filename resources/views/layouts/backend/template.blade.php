...
<html lang="en">
    ...
    <head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="{{asset('admiiin/assets/images/favicon.ico')}}">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col fs-13 text-muted text-center">
                                &copy; <script>document.write(new Date().getFullYear())</script> - Made with <span class="mdi mdi-heart text-danger"></span> by <a href="#!" class="text-reset fw-semibold">TB KURNIA JAYA</a>
                            </div>
                        </div>
                    </div>
                </footer>
...
<html lang="en">
    ...
    <head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="admiiin/assets/images/favicon.ico">

        <!-- App css -->
        <link href="admiiin/assets/css/app.min.css" rel="stylesheet" type="text/css" id="app-style" />

        <!-- Icons -->
        <link href="admiiin/assets/css/icons.min.css" rel="stylesheet" type="text/css" />
